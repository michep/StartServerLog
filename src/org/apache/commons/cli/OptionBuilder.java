...
public final class OptionBuilder
{
    ...
    /** order for HelpFormatter */
    private static String helpOrder;
    ...
    /**
     * The next Option created will have this help order.
     *
     * @return the OptionBuilder instance
     */
    public static OptionBuilder withHelpOrder(String helpOrder)
    {
        OptionBuilder.helpOrder = helpOrder;
